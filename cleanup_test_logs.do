...
local test_logs `test_logs' "ado/ancillary_files/test/log/dtparquet_test1.log"
local test_logs `test_logs' "ado/ancillary_files/test/log/dtparquet_test2.log"
local test_logs `test_logs' "ado/ancillary_files/test/log/dtparquet_test3.log"
local test_logs `test_logs' "ado/ancillary_files/test/log/dtparquet_test4.log"
local test_logs `test_logs' "ado/ancillary_files/test/log/dtparquet_test5.log"
local test_logs `test_logs' "ado/ancillary_files/test/log/dtparquet_test6.log"
...
local root_logs `root_logs' "dtparquet_test1.log"
local root_logs `root_logs' "dtparquet_test2.log"
local root_logs `root_logs' "dtparquet_test3.log"
local root_logs `root_logs' "dtparquet_test4.log"
local root_logs `root_logs' "dtparquet_test5.log"
local root_logs `root_logs' "dtparquet_test6.log"
...
local root_logs `root_logs' "dtparquet_examples.log"
...
local old_test_logs `old_test_logs' "ado/ancillary_files/test/dtparquet/dtparquet_test1.log"
local old_test_logs `old_test_logs' "ado/ancillary_files/test/dtparquet/dtparquet_test2.log"
local old_test_logs `old_test_logs' "ado/ancillary_files/test/dtparquet/dtparquet_test3.log"
local old_test_logs `old_test_logs' "ado/ancillary_files/test/dtparquet/dtparquet_test4.log"
local old_test_logs `old_test_logs' "ado/ancillary_files/test/dtparquet/dtparquet_test5.log"
local old_test_logs `old_test_logs' "ado/ancillary_files/test/dtparquet/dtparquet_test6.log"
...
// List of temporary Parquet files that might be created
local temp_parquet ""
local temp_parquet `temp_parquet' "test.parquet"
local temp_parquet `temp_parquet' "test_data.parquet"
local temp_parquet `temp_parquet' "test_compression.parquet"
local temp_parquet `temp_parquet' "test_types.parquet"
...
di _n "Cleaning up temporary Parquet files..."
foreach file in `temp_parquet' {
    capture confirm file "`file'"
    if _rc == 0 {
        capture erase "`file'"
        if _rc == 0 {
